// Sidebar Component
import { SidebarProps } from "@/interfaces/admin.interface";
...
const Sidebar: React.FC<SidebarProps> = ({ isOpen }) => {
  ...
  { icon: Bot, label: 'Doctors', badge: 'NEW', path: '/admin/doctors' },
  { icon: ShoppingCart, label: 'Patients', badge: 'NEW', path: '/admin/users' },
