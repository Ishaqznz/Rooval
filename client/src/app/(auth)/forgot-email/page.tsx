...
import { VERIFY_RESET_TOKEN } from '@/graphql/queries/auth';
  ...
  useEffect(() => {
    const verifyEmail = async () => {
      try {
        ...
        const query = {
          query: VERIFY_RESET_TOKEN.query,
          variables: {
            input: { token }
          }
        };
        ...
        if (mockSuccess) {
          setStatus('success');
          setMessage('Email verified successfully! Redirecting to reset password page...');
            ...
            <div className="bg-gray-50 border border-gray-200 rounded px-4 py-6 text-center">
              ...
              {status === 'success' && (
                <div className="text-gray-600">
                  ...
                  <p>You'll be redirected to your reset password page shortly.</p>
                </div>
              )}
