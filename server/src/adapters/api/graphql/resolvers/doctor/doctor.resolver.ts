...
import { ChangeDoctorStatusInput } from '../../types/doctor/input/changeStatus.input';
import { Doctor } from '../../types/doctor/model/doctor.model';
import { DeleteDoctorInput } from '../../types/doctor/input/deleteDoctor.input';
import { JwtAdminGuard } from '../../../../../common/guards/admin.guard';
import { UseGuards } from '@nestjs/common';
import { DoctorOnboardingInput } from '../../types/doctor/input/onboarding.input';
import { JwtAuthGuard } from '../../../../../common/guards/auth.guard';
import { DoctorFileUploadInput } from '../../types/doctor/input/fileupload.input';
import { DoctorFileUpdateInput } from '../../types/doctor/input/file-reupload.input';
import { FindDoctorsInput } from '../../types/doctor/input/findDoctors.input';
import { IDoctorUseCase } from '../../../../../application/use-cases/interface/doctor.usecase.interface';
import { RejectionReasonInput } from '../../types/doctor/input/rejectionReason.input';
import { CountDoctorsInput } from '../../types/doctor/input/countDoctors.input';
import { GqlContext } from '../../../../../common/types/gql-context.type';
import { FindByUsernameInput } from '../../types/doctor/input/findByUsername.input';
import { UpdateDoctorProfileInput } from '../../types/doctor/input/updateProfile.input';
import { ChangePasswordInput } from '../../types/doctor/input/changePassword.input';
