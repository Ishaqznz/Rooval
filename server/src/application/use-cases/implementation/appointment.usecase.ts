...
import { AppointmentInputMapper } from "../../mapper/appointment/appointment.input.mapper";
import { BusinessRuleViolationError } from "../../../core/errors/businessRule.error";
import { AppointmentOutputMapper } from "../../mapper/appointment/appointment.output.mapper";
...
import { NotificationMessages, NotificationType } from "../../../core/enums/notifications/notification.enum";
...
import { AppointmentDomainService } from "../../../core/services/appointment/appointment.service.core";
import { IWalletUseCase } from "../interface/wallet.usecase.interface";
import { WalletErrorType, WalletTransactionReason, WalletTransactionType } from "../../../core/enums/wallet/wallet.enum";
